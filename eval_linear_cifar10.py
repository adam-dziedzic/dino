...
def eval_linear(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train(model, linear_classifier, optimizer, train_loader, epoch, args.n_last_blocks,
                            args.avgpool_patchtokens, scheduler, best_acc)
        scheduler.step()
        ...
        if utils.is_main_process():
            ...
            torch.save(save_dict, os.path.join(args.output_dir, f"checkpoint-{epoch}.pth.tar"))
    print("Training of the supervised linear classifier on frozen features completed.\n"
          "Top-1 test accuracy: {acc:.1f}".format(acc=best_acc))


def train(model, linear_classifier, optimizer, loader, epoch, n, avgpool, scheduler, best_acc):
    ...
    for (inp, target) in metric_logger.log_every(loader, 20, header):
        ...
        if utils.is_main_process() and iter % 10 == 0:
            ...
            torch.save(save_dict, os.path.join(args.output_dir, f"checkpoint-{epoch}-{iter}.pth.tar"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights',
                        default='/mfsnic/adam/dino-small-fine-tune-cifar10/dino_deitsmall16_pretrain_full_checkpoint.pth',
    ...
    parser.add_argument('--data_path', default='/mfsnic/datasets/cifar10/', type=str)
    parser.add_argument('--num_workers', default=10, type=int, help='Number of data loading workers per GPU.')
    parser.add_argument('--val_freq', default=1, type=int, help="Epoch frequency for validation.")
    parser.add_argument('--output_dir', default="/mfsnic/adam/dino-small-fine-tune-cifar10-fine-grained",
